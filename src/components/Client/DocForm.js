...
const DocForm = () => {
  ...
  const getRegisterDate = async () => {
    const response = await axiosJWT.get(
      `${process.env.REACT_APP_BACKEND_URL}/getRegisterDate`,
      {
        params: {
        ...
        <div id="form1Content">
            ...
            <div className="row">
              <div>
                ...
                <div className="col-lg-4 space ">
                  ...
                  <br />
                  &nbsp;
                  <button className={styleph} onClick={CuploadPhoto}>
                    {buttonTextph}
                  </button>
                </div>
                <input
                ...
                <div className="col-md-4 box space">
                  <input
                    ...
                    onChange={saveDischarge_Book}
                    required
                  />
                  <br />
                  <button className={styled} onClick={CuploadDischarge}>
                    {buttonTextd}
                  </button>
                </div>
                ...
                <div className="col-md-4 space box line" disabled={disable}>
                  ...
                  />
                  <br />
                  <button className={stylea} onClick={CuploadAdhar}>
                    {buttonTexta}
                  </button>
                </div>
                ...
                <div className="col-md-4 box space">
                  ...
                  />
                  <br />
                  <button className={stylep} onClick={CuploadPAN}>
                    {buttonTextp}
                  </button>
                </div>
                ...
                <div className="col-md-4 box space">
                  ...
                  />
                  <br />
                  <button className={stylev} onClick={CuploadVoter}>
                    {buttonTextv}
                  </button>
                </div>
                ...
                <div className="col-md-4  box space">
                  ...
                  />
                  <br />
                  <button className={stylee} onClick={CuploadECHS}>
                    {buttonTexte}
                  </button>
                </div>
                ...
                <div className="col-md-4 box space">
                  ...
                  />
                  <br />
                  <button className={styleppo} onClick={CuploadPPO}>
                    {buttonTextppo}
                  </button>
                </div>
              </div>
          ...
          >
            ...
            <button className=" btn">
              <Link to="/Form4">Back</Link>{" "}
            </button>
            <button className="btn my-2 my-sm-0 ">
              <Link to="/Form6">Next</Link>{" "}
            </button>
          </div>
          {/*      //****   FOOTERS *********   */}
        </div>
