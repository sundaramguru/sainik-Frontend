            ...
            <div className="upperForm1Content">
              ...
              >
                <button className=" btn">
                  <Link to="/vForm7">Back</Link>{" "}
                </button>
                <button className=" btn">
                  <Link to="/vd_doc">Next</Link>{" "}
                </button>
              </div>
            </div>
          </form>
