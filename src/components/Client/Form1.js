...
const Form1 = () => {
  ...
  const [Corps_Name, setCorps_Name] = useState(
    localStorage.getItem("Corps_Name")
  );
  ...
  const [Rank_Category, setRank_Category] = useState(
    localStorage.getItem("Rank_Category")
  );
  const [Rank_Category_Id, setRank_Category_Id] = useState(
    localStorage.getItem("Rank_Category_Id")
  );
  const [V_Rank_Category, setV_Rank_Category] = useState(
    localStorage.getItem("V_Rank_Category")
  );
  ...
  const [Enroll_Date, setEnroll_Date] = useState(
    localStorage.getItem("Enroll_Date")
  );
  const [World_War2, setWorld_War2] = useState(
    localStorage.getItem("World_War2")
  );
  const [Opt_Attend, setOpt_Attend] = useState(
    localStorage.getItem("Opt_Attend")
  );
  ...
  const getDDOB = async () => {
    const response = await axiosJWT.get(
      `${process.env.REACT_APP_BACKEND_URL}/getDOB`,
      {
        params: {
          Service_No: Service_No,
        },
  ...
  const getForm1 = async () => {
    const response = await axiosJWT.get(
      `${process.env.REACT_APP_BACKEND_URL}/getForm1`
    );
...

  {
    /*const getCorp = async () => {
      ...
      const response = await axiosJWT.get(`${process.env.REACT_APP_BACKEND_URL}/Corps_Depend`,
          {
              params:{corps:sn}
          });
      setCorp(response.data);
...
*/
  ...
  const getRecord = async () => {
    ...
    const response = await axiosJWT.get(
      `${process.env.REACT_APP_BACKEND_URL}/record_D`,
      {
        params: { record: sn },
      }
    );
  ...
  const getTrade = async () => {
    ...
    const response = await axiosJWT.get(
      `${process.env.REACT_APP_BACKEND_URL}/trade_D`,
      {
        params: { Service_Name: sn, Group: g },
      }
    );
  ...
  const getRank = async () => {
    ...
    const response = await axiosJWT.get(
      `${process.env.REACT_APP_BACKEND_URL}/rank_D`,
      {
        params: { Service_Name: sn, Rank_Category: rc },
      }
    );
  ...
  const creatRow = async (e) => {
    ...
    try {
      const res = await axios.post(
        `${process.env.REACT_APP_BACKEND_URL}/creatRow`,
        formData
      );
  ...
  const Form1 = async (e) => {
    e.preventDefault();
    try {
      // await axios.post(`${process.env.REACT_APP_BACKEND_URL}/u_service_details`, {
      // Service_No:Service_No,
    ...
    <div className="center">
      <div className="wrapper fadeInDown">
        <div id="form1Content">
          <form onSubmit={Form1}>
            <div
              className="text-center text-dark p-3 bottom-shade"
                ...
                <div className="col-lg-12 space  ">
                  <div className="row">
                    ...
                    <div className="col-lg-4 space">
                      <select
                        className="col-lg-9 dropdown_align"
                        value={Service_Name}
                        onChange={(e) => setService_Name(e.target.value)}
                        onClick={getVisibleRecord}
                        required
                      >
      ...
      height={100} width={50} />
                ...
                <div className="col-lg-4 space">
                  ...
                  >
                    ...
                    {rank.map((user, index) => (
                      <option key={user.id} value={user.Rank_Name}>
                        {user.Rank_Name}
                      </option>
                    ))}
                  </select>
                ...
                <div className="col-md-4 space">
                  <select
                    ...
                    required
                  >
                    <option value="Group_Name" disabled selected>
                      -- Select Group --
                    </option>
                    {GROUP.map((c) => (
                ...
                <div className="col-lg-4 space">
                  ...
                  >
                    ...
                    {trade.map((user, index) => (
                      <option key={user.id} value={user.Trade_Name}>
                        {user.Trade_Name}
                      </option>
                    ))}
                  </select>
                ...
                <div className="col-lg-4 space">
                  <input
                    ...
                    name="Enroll_Date"
                    value={Enroll_Date}
                    onChange={onEnrolldChange}
                    onKeyPress={onEnrolld}
                    required
                  />
                </div>
                ...
                <div className="col-lg-4 space">
                  <div className="form-check form-check-inline">
                    <input
                      ...
                      name="World_War2"
                      value="Yes"
                      onChange={(e) => setWorld_War2(e.target.value)}
                    />
                ...
                <div className="col-lg-4 space">
                  <input
                    ...
                    name="Opt_Attend"
                    value={Opt_Attend}
                    onChange={(e) => setOpt_Attend(e.target.value)}
                  />
                </div>
