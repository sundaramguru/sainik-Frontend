...
const ViewFormDoc = () => {
  ...
  const getUsers = async () => {
      ...
      const response = await axiosJWT.get('http://localhost:5000/UserViewFormDoc',{
        params:{
          V_Service_No: sn
        }
      });
...
<div  className = "right-align ">
 <img src={users[7]} className='docPhoto' width='150'onClick={()=> window.open(users[7], "_blank")} />
 </div>


        <FormLabels text={"Adhaar Card"} />
        <div className="col-md-4 space box line">
        <input type="text" className = "trial col-lg-12 "  value={users[1]}/><br/>
      ...
      {/*<img src={users[3]} alt={users[3]} width='350' />*/}
        ...
        <input type="text" className = "trial col-lg-12 "   value={users[2]}/><br/>
        <File v={users[2]}name={'voter'}></File>
        </div><br/>

        <FormLabels text={"PAN Card"} />
        <div className="col-md-4 space box ">
        <input type="text" className = "trial col-lg-12 "  value={users[3]}/><br/>
        <File v={users[3]}name={'PAN'}></File>
        </div><br/>

        <FormLabels text={"PPO Card"} />
        <div className="col-md-4 space box ">
        <input type="text" className = "trial col-lg-12 "   value={users[4]}/><br/>
        <File v={users[4]}></File>
        </div><br/>

        <FormLabels text={"ECHS Card"} />
        <div className="col-md-4 space box ">
        <input type="text" className = "trial col-lg-12 "  value={users[5]}/><br/>
        <File v={users[5]}></File>
        </div><br/>
        ...
        <div className="col-md-4 space box ">
        <input type="text" className = "trial col-lg-12 "  value={users[6]}/><br/>
        <File  v={users[6]}></File>
        </div><br/>

      <button className = " btn btn-secondary"onClick={()=> window.open(users[7], "_blank")}>Open ESM Photo</button>
      <div className="text-center text-dark p-3 foot" style={{backgroundColor: "#DBE6FD"}}>
      <button className=" btn" ><Link to="/ViewForm5a">Back</Link> </button>
      <button className=" btn" ><Link to="/ViewForm6a">Skip</Link> </button>

      <button className="btn my-2 my-sm-0 " ><Link to="/ViewFormDocb">Edit</Link> </button>
      </div>
  </div>
