  ...
  localStorage.setItem('Reg_TypeForm','Not Registered')
    ...
    return (
      ...
      <div id="formContent">
         ...
         <div><br/>
         <span style={{color: 'white', fontWeight : '900', fontStyle : 'italic' , fontFamily : 'Times New Roman'}} > SELECT YOUR REGISTRATION TYPE</span><br/><br/>
         <span style={{color: 'white', fontWeight : '900', fontStyle : 'italic' , fontFamily : 'Times New Roman'}} > {Service_No}</span><br/><br/>
         <span style={{color: 'white', fontWeight : '900', fontStyle : 'italic' , fontFamily : 'Times New Roman'}} > {Status}</span><br/><br/>

        </div>  </div>

        <input type="hidden" class="fadeIn third textInput" name="login" value={Reg_Type} />
        <input type="hidden" class="fadeIn third textInput" name="login" value={Emp_Status} />
        ...
        {/**/}   {visibleEmp && <div>
                      {v3 && <div>
          <button class=" btn"style={{backgroundColor:"#243A73",color:"#fff"}} ><Link to="/formue"> Employment Registration </Link></button><br /><br />
</div>}


                    {EmpView && <div>
                    <button  class="btn "style={{backgroundColor:"#243A73",color:"#fff"}} ><Link to="/Vformue">View Employment Registration </Link></button><br /><br />
                    </div>}
                    {EmpEdit && <div>
                    <button  class="btn "style={{backgroundColor:"#243A73",color:"#fff"}} ><Link to="/viewformuea">Edit Employment Registration </Link> </button><br /><br />
                    </div>}
                    </div>}
...
{visibleWidow && <div>
          ...
          {WV && <div>
          <button  class="btn "style={{backgroundColor:"#243A73",color:"#fff"}} ><Link to="/Vwidwform">View Registration </Link></button><br /><br />
          </div>}
          {WE && <div>
          <button  class="btn "style={{backgroundColor:"#243A73",color:"#fff"}} ><Link to="/Viewformwa">Edit Registration </Link> </button><br /><br />
          </div>}
          </div>}
