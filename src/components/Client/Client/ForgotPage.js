...
return (
	 ...
	 <div className="center">
      ...
      <div id="formContent">
        ...
        <input type="email"  class="fadeIn third textInput"   autocomplete ="off"  name="Mail_Id" value={Mail_Id[0]} onChange={(e) => setMail_Id(e.target.value)} /><br/>
       <a onClick = {getMail} class="btn btn-primary">get mail</a><br/><br/>

        <input type="submit" class="btn btn-secondary" value = "SEND EMAIL TO USER FOR VERIFICATION"  />
 ...
 { visible &&
        ...
        <input type="password" id="password" class="fadeIn third passwordInput"   autocomplete ="off"  name="pass" placeholder="Create New Password" value={Password}  onClick={(e) => validate(e.target.value)} onChange={onpasswordChange}/><br/>
           ...
           <input type="password" id="password" class="fadeIn third passwordInput" name="conpass"   autocomplete = "off"  maxlength = "10" placeholder="Confirm Password"value={ConfPassword}  onCick={PasswordCheck} onChange={(e) => setConfPassword(e.target.value)} />
        ...
        <div id="formFooter">
          ...
          <input onClick={ForgetPass}  class=" btn btn-info"   value="Reset Password" />
