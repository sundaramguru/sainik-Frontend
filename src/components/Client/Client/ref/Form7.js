...
// await axios.post('http://localhost:5000/Form6', {
//   //form6
//
//                   Service_No:localStorage.getItem('Service_No') ,
...
//                   Spouse_PAN: localStorage.getItem('Divorce_Date') ,
//                   Spouse_CSD: localStorage.getItem('Court_Order') ,
//                   Spouse_ECHS: localStorage.getItem('Death_Date'),
//
//
// });
