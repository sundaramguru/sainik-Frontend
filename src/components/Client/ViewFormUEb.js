...
{/*---------------------------------------------GET KEY ----------------------------------------*/}
              <div className="col-lg-12 space  ">
               ...
               <input type="text"  class="  formInput" autocomplete = "off" maxlength = "20"  onClick = {calAge} name="ESM_No" value={ESM_No} onChange={(e) => setESM_No(e.target.value)}required />
               </div>

                 <FormLabel text={"Civil Qualification"} />
                 <div className="col-md-4 space">
                 <input type="text"  class="  formInput" autocomplete = "off" maxlength = "20"  name="Civil_Qualification" value={Civil_Qualification} onChange={(e) => setCivil_Qualification(e.target.value)}required />
                  </div>
                ...
                <input type="text"  class="  formInput" autocomplete = "off" maxlength = "20"  name="Addi_Course1" value={Addi_Course1} onChange={(e) => setAddi_Course1(e.target.value.toUpperCase())} />
                      ...
                      <div className="col-md-4 space">
                      <input type="text"  class="  formInput" autocomplete = "off" maxlength = "20"  name="Trade_Name" value={Trade_Name} onChange={(e) => setTrade_Name(e.target.value)} required/>
                      </div>
