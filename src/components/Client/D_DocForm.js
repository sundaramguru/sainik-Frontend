...
const DocForm = () => {
  ...
  const onDepNameChange = (e) => {
    ...
    if (
      ...
      a.test(e.target.value.toUpperCase())
    ) {
...
{RELATION.map(c => <option key={c}>{c}</option>)}
                ...
                <div className="col-md-4 space box line">
                  <input
                    ...
                    onChange={saveD_Adhar}
                  />
                  <br />
                  <button className={stylea} onClick={DuploadAdhar}>
                    {buttonTexta}
                  </button>
                </div>
                ...
                <div className="col-md-4 box space">
                  ...
                  />
                  <br />
                  <button className={stylep} onClick={DuploadPAN}>
                    {buttonTextp}
                  </button>
                </div>
                ...
                <div className="col-md-4 box space">
                  <input
                    ...
                    name="D_Voter"
                    accept="application/pdf"
                    onChange={saveD_Voter}
                  />
                  <br />
                  <button className={stylev} onClick={DuploadVoter}>
                    {buttonTextv}
                  </button>
                </div>
                ...
                <div className="col-md-4  box space">
                  ...
                  />
                  <br />
                  <button className={stylee} onClick={DuploadECHS}>
                    {buttonTexte}
                  </button>
                </div>
              </div>
          ...
          >
            ...
            <button className=" btn">
              <Link to="/form7">Back</Link>{" "}
            </button>
            <button className="btn my-2 my-sm-0 ">
              <Link to="/form7">Add</Link>{" "}
            </button>
          </div>
          {/*      //************   FOOTERS *************************   */}
        </div>
