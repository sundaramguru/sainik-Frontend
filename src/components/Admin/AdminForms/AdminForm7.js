...
{/*     -----------------------------------------  FOOTER  SECTION -------------------------------------------------
    ...
    <button className=" btn  " ><Link to="/Query">Send Query</Link> </button>
        ...
        (() => {
            if(ad == "Clerk") {
                    return (
                      ...
                      <button id="verified"onClick={Verify}className="btn my-2 my-sm-0 right-align "  >Verify </button>

                    )
                } else if (ad == "Superintendent") {
                    return (

                       <button id="verified"onClick={Recommend}className="btn my-2 my-sm-0 right-align "   >Recommend </button>

                    )
                } else {
                    return (

                      <button className="btn my-2 my-sm-0 right-align " onClick={Approve} >Approve </button>
...

{
    (() => {
        if(ad == "Clerk") {
                ...
                <button className="btn my-2 my-sm-0 "onClick={ClerkQ} ><strong>Post</strong> </button>
                  </div>
                )
            } else if (ad == "Superintendent") {
                return (
                ...
                <button className="btn my-2 my-sm-0 "onClick={SuperintendentQ} ><strong>Post</strong> </button>
                  </div>
                )
            } else {
                return (
              ...
              <h2><strong>Superintendent</strong></h2>
                ...
                <button className="btn my-2 my-sm-0 "onClick={DirectorQ} ><strong>Post</strong> </button>
                  </div>
                )
            }
    })()
