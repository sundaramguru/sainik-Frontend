...
// {dataField: 'Relation', text: 'Sl.No', sort: true, filter: textFilter()},
 ...
 {dataField: 'vService', text: 'Service_Name' , sort: true , hidden : false,filter: textFilter()},
 {dataField: 'Corps_Name', text: 'Corps_Name',hidden : false, sort: true , filter: textFilter()},
 {dataField: 'Record_Office_Name', text: 'Record_Office_Name',hidden : false, sort: true , filter: textFilter()},
 {dataField: 'Group_Name', text: 'Group_Name',hidden : false, sort: true , filter: textFilter()},
 {dataField: 'Trade_Name', text: 'Trade_Name',hidden : false, sort: true , filter: textFilter()},

 {dataField: 'vTrade', text: 'Trade_Name',hidden : false, sort: true , filter: textFilter()},
 {dataField: 'vRank', text: 'Rank_Name',hidden : false, sort: true , filter: textFilter()},
 //{dataField: 'Rank_Category', text: 'Rank_Category',hidden : false, sort: true , filter: textFilter()},
 {dataField: 'Name', text: 'Name',hidden : false, sort: true , filter: textFilter()},
 {dataField: 'Gender', text: 'Gender',hidden : false, sort: true , filter: textFilter()},
 {dataField: 'DOB', text: 'DOB',hidden : false, sort: true , filter: textFilter()},
 {dataField: 'Enroll_Date', text: 'Enroll_Date',hidden : false, sort: true , filter: textFilter()},
 {dataField: 'World_War2', text: 'World_War2',hidden : false, sort: true , filter: textFilter()},
 {dataField: 'Opt_Attend', text: 'Opt_Attend',hidden : false, sort: true , filter: textFilter()},
 {dataField: 'Deco', text: 'Deco',hidden : false, sort: true , filter: textFilter()},
...
{/*   -----------------------------------------  HEADER  SECTION ------------------------------------------------- */}
    ...
    <select  className="col-lg-6 dropdown_align"value={Column_Attribute} onClick={ ColumnVisible} >
