...
const axiosJWT = axios.create();
    ...
    const getfzsb = async () => {
    const response = await axiosJWT.get('http://localhost:5000/F_Rank');
...
const columns = [
 ...
 {dataField: 'Rank_Category_Id', text: 'Rank Category Id ', sort: true,filter: textFilter() },
  ...
  const pagination = paginationFactory({
    ...
    return (
      ...
      <div id="formContent">
        ...
        <div >
        <select id="login"className="fadeIn second textInput" value ={Service_Name} onChange={(e)=> setService_Name(e.target.value)} required >
        ...
        <div >
        <select id="login"className="fadeIn second textInput" value ={Rank_Category} onChange={(e)=> setRank_Category(e.target.value)} required>
        ...
        <input type="text" id="login" class="fadeIn second textInput"  placeholder="Rank Name"value={Rank_Name} onChange={(e) => setRank_Name(e.target.value)} required/>
