...
const columns = [
 {dataField: 'id', text: 'Record Office Id', sort: true, filter: textFilter()},
 {dataField: 'Corps_Name', text: 'Corps Name', sort: true,filter: textFilter() },
 {dataField: 'Record_Office_Name', text: 'Record Office Name', sort: true , filter: textFilter()},
 {dataField: 'Record_Office_Location', text: 'Record Office Location', sort: true , filter: textFilter()},
 {dataField: 'Dist_Surname', text: 'District Surname', sort: true , filter: textFilter()},
 {dataField: 'Record_Office_Mail', text: 'Record Office Mail', sort: true , filter: textFilter()},
 {dataField: 'Record_Office_Mobile', text: 'Record Office Mobile', sort: true , filter: textFilter()},
 ]
  ...
  const pagination = paginationFactory({
    ...
    return (
      ...
      <div id="formContent">
        ...
        <div >
        <select id="login"className="fadeIn second textInput" value ={Corps_Name} onChange={(e)=> setCorps_Name(e.target.value)} required>
        ...
        <input type="text" id="login" class="fadeIn second textInput"  placeholder="Record_Office_Name"value={Record_Office_Name} onChange={(e) => setRecord_Office_Name(e.target.value)} required/>
        <input type="text" id="login" class="fadeIn second textInput"  placeholder="Location"value={Location} onChange={(e) => setLocation(e.target.value)} required/>
        <div >
        ...
        <input type="text" id="login" class="fadeIn second textInput"  placeholder="Mail"value={Mail} onChange={(e) => setMail(e.target.value)} required/>
        <input type="text" id="login" class="fadeIn second textInput"  placeholder="Mobile"value={Mobile} onChange={(e) => setMobile(e.target.value)}  required/>
