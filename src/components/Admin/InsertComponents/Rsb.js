  ...
  const pagination = paginationFactory({
    ...
    return (
      ...
      <div id="formContent">
        ...
        <input type="text" id="login" class="fadeIn second textInput"  placeholder="RSB_Name"value={RSB_Name} onChange={(e) => setRSB_Name(e.target.value)} required />
        <input type="text" id="login" class="fadeIn second textInput"  placeholder="RSB_Surname"value={RSB_Surname} onChange={(e) => setRSB_Surname(e.target.value)} required/>
