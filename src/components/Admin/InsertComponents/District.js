  ...
  const pagination = paginationFactory({
    ...
    return (
      ...
      <div id="formContent">
        ...
        <h1 className='insert-pad'><strong>District</strong></h1><br/>

        <div >
        <select id="login"className="fadeIn second textInput" value ={ZSB_Name} onChange={(e)=> setZSB_Name(e.target.value)} required >
        ...
        <div >
        <select id="login"className="fadeIn second textInput" value ={State} onChange={(e)=> setState(e.target.value)} required>
        ...
        </div>         <input type="text" id="login" class="fadeIn second textInput"  placeholder="District"value={Dist} onChange={(e) => setDist(e.target.value)}  required />
        <input type="text" id="login" class="fadeIn second textInput"  placeholder="District Code"value={Dist_Code} onChange={(e) => setDist_Code(e.target.value)}   required/>
