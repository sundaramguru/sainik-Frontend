...
const MedicalCategory = () => {
  ...
  const columns = [
 {dataField: 'id', text: 'Medical Category Id', sort: true, filter: textFilter()},
 {dataField: 'Service_Id', text: 'Service Id', sort: true,filter: textFilter() },
 {dataField: 'Discharge_Med_Cat', text: 'Discharge Medical Category', sort: true , filter: textFilter()},
...
const pagination = paginationFactory({
    ...
    return (
      ...
      <div id="formContent">
        ...
        <input type="text" id="login" class="fadeIn second textInput"  placeholder="Medical Category"value={Medical_Category} onChange={(e) => setMedical_Category(e.target.value)} required/>
