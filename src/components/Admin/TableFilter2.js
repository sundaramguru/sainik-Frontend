...
const TableFilter2 = () => {
  ...
  const columns = [
    ...
    {
      dataField: "vRank_Category",
      text: "Rank Category",
      hidden: hideRankCategory,
      sort: true,
      filter: textFilter(),
    },
    {
    ...
    },
    {
      ...
      text: "World War2",
      hidden: hideWorldWar2,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Opt_Attend",
      text: "Operation Attended",
      hidden: hideOA,
      sort: true,
      filter: textFilter(),
    },
    ...
    // Form2
    {
      dataField: "Unit_Last_Served",
      text: "Unit Last Served",
      hidden: hideUL,
      sort: true,
      filter: textFilter(),
    },
    ...
    {
      dataField: "vDischarge_Character",
      text: "Discharge Character",
      hidden: hideDC,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Dep_Qualification",
      text: "Discharge Book No",
      hidden: hideDB,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "If_Pensioner",
      text: "If Pensioner",
      hidden: hideIP,
      sort: true,
      filter: textFilter(),
    ...
    {
      dataField: "Pension_Sanctioned",
      text: "Pension Sanctioned",
      hidden: hidePS,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "If_Sanctioned_Dis_Pension",
      text: "If Sanctioned Dis Pension",
      hidden: hideISDP,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Disability_Pension",
      text: "Disability Pension",
      hidden: hideDP,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Disability_Percentage",
    ...
    {
      dataField: "City_Village",
      text: "Present City Village",
      hidden: hidePCV,
      sort: true,
      filter: textFilter(),
    },
    ...
    {
      dataField: "House_No",
      text: "Present House No",
      hidden: hidePHN,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Police_Station",
      text: "Present Police Station",
      hidden: hidePPS,
      sort: true,
      filter: textFilter(),
    },
    ...
    {
      dataField: "vP_Taluk_Name",
      text: "Permanent Taluk",
      hidden: hidePPT,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "P_Locality",
      text: "Permanent Locality",
      hidden: hidePPL,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "P_City_Village",
      text: "Permanent City Village",
      hidden: hidePPCV,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "P_Street",
      text: "Permanent Street",
      hidden: hidePPPPS,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "P_House_Name",
      text: "Permanent House Name",
      hidden: hidePPH,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "P_House_No",
      text: "Permanent House No",
      hidden: hidePPHN,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "P_Police_Station",
      text: "Permanent Police Station",
      hidden: hidePPPSS,
      sort: true,
      filter: textFilter(),
    },
    ...
    // // Form5
    {
      dataField: "vCivil_Qualification",
      text: "Civil Qualification",
      hidden: hideCivil_Qualification,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Addi_Course",
      text: "Additional Course",
      hidden: hideAddi_Course,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Equi_Test",
      text: "Equivalent Test passed",
      hidden: hideEqui_Test,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Civil_Emp_Status",
      text: "Civil Employment Status",
      hidden: hideCivil_Emp_Status,
      sort: true,
      filter: textFilter(),
    },
    {
    ...
    {
      dataField: "Pres_Desg",
      text: "Present Designation",
      hidden: hidePres_Desg,
      sort: true,
      filter: textFilter(),
    },
    {
    ...
    {
      dataField: "Month_Income",
      text: "Monthly Income",
      hidden: hideMonth_Income,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Official_No",
      text: "Official No",
      hidden: hideOfficial_No,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Desg_Retire",
      text: "Designation While Retirement ",
      hidden: hideDesg_Retire,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Retire_Date",
      text: "Date of Retirement",
      hidden: hideRetire_Date,
      sort: true,
      filter: dateFilter(),
    },
    {
      dataField: "Civil_PPO_No",
      text: "Civil PPO No",
      hidden: hideCivil_PPO_No,
      sort: true,
      filter: textFilter(),
    },
    ...
    {
      dataField: "Spouse_Relation",
      text: "Spouse Relation",
      hidden: hideMR,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Spouse_DOB",
      text: "Spouse DOB",
      hidden: hideMDOB,
      sort: true,
      filter: textFilter(),
    ...
    {
      dataField: "Spouse_Voter_Id",
      text: "Spouse Voter Id",
      hidden: hideMVI,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Spouse_PAN",
      text: "Spouse PAN",
      hidden: hideMPAN,
      sort: true,
      filter: textFilter(),
    ...
    {
      dataField: "Spouse_Id_Mark",
      text: "Spouse Identification Mark",
      hidden: hideMIM,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Spouse_Qualification",
      text: "Spouse Qualification",
      hidden: hideMQ,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Spouse_Emp_Status",
      text: "Spouse Employment Status",
      hidden: hideMES,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Spouse_Sector",
      text: "Spouse Sector",
      hidden: hideMSS,
      sort: true,
      filter: textFilter(),
    ...
    {
      dataField: "Spouse_Dept",
      text: "Spouse Department",
      hidden: hideSSSSD,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Spouse_Pres_Desg",
      text: "Spouse Present Designation",
      hidden: hideMPD,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Spouse_Employer",
      text: "Spouse Employer",
      hidden: hideSE,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Spouse_Official_No",
      text: "Spouse Official No",
      hidden: hideMO,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Spouse_Month_Income",
    ...
    {
      dataField: "Spouse_Desg_Retire",
      text: "Spouse Designation",
      hidden: hideMSP,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Spouse_Retire_Date",
      text: "Spouse Retirement Date",
      hidden: hideMRD,
      sort: true,
      filter: dateFilter(),
    },
    {
      dataField: "Spouse_Civil_PPO_No",
      text: "Spouse Civil PPO No",
      hidden: hideMCP,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Divorce_Date",
      text: "Divorce Date",
      hidden: hideMDDD,
      sort: true,
      filter: dateFilter(),
    ...
    {
      dataField: "Court_Order",
      text: "Court Order",
      hidden: hideMCCC,
      sort: true,
      filter: textFilter(),
    },
    { dataField: "ESM_No", text: "ESM No", sort: true, filter: textFilter() },
  ];
  // // WidowForm
  const columnsw = [
    { dataField: "Service_No", text: "Service No", filter: textFilter() },
    ...
    {
      dataField: "Family_Pension",
      text: "Family Pension",
      hidden: hideFamily_Pension,
      sort: true,
      filter: textFilter(),
    },
    {
      ...
      text: "Death Date",
      hidden: hideDeath_Date,
      sort: true,
      filter: dateFilter(),
    },
    {
      dataField: "Death_Nature",
      text: "Death Nature",
      hidden: hideDeath_Nature,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Widow_Reg_No",
      text: "Widow Registration No",
      hidden: hideW_No,
      sort: true,
      filter: textFilter(),
    },
  ...
  const columnse = [
    ...
    },
    {
      ...
      text: "Trade_Code",
      hidden: hideTrade_Code,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Civil_Qualification",
      text: "Civil Qualification",
      hidden: hideCivil,
      sort: true,
      filter: textFilter(),
    ...
    {
      dataField: "Addi_Course1",
      text: "Additional Course 1",
      hidden: hideAddi_Course1,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Addi_Course2",
      text: "Additional Course 2",
      hidden: hideAddi_Course2,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Addi_Course3",
      text: "Additional Course 3",
      hidden: hideAddi_Course3,
      sort: true,
      filter: textFilter(),
    },
    {
      dataField: "Addi_Course4",
      text: "Additional Course 4",
      hidden: hideAddi_Course4,
      sort: true,
      filter: textFilter(),
    },
    { dataField: "ESM_No", text: "ESM No", sort: true, filter: textFilter() },
  ...
  const getUsers1 = async () => {
    const sn = localStorage.getItem("Service_No");
    const response = await axiosJWT.get(
      `${process.env.REACT_APP_BACKEND_URL}/awidowforma`
    );
  ...
  const getUsers2 = async () => {
    // const sn=localStorage.getItem('Service_No');
    const response = await axiosJWT.get(
      `${process.env.REACT_APP_BACKEND_URL}/adminformuee`
    );
    ...
    <div className="center">
      <div class="wrapper fadeInDown">
        ...
        <div className="upperForm1Content">
            ...
            <div className="row">
              <div className="col-md-7 space">
                <select
                  ...
                  onChange={(e) => setColumn_Attribute(e.target.value)}
                >
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <button className="btn btn-secondary right-align" onClick={viewesm}>
            ESM Record{" "}
          </button>
          &nbsp;&nbsp;&nbsp;
          <button
            className="right-align btn btn-secondary "
            onClick={viewwidow}
          >
            Widow Record{" "}
          </button>
          &nbsp;&nbsp;&nbsp;
          <button className="btn btn-secondary right-align" onClick={viewemp}>
            Employed Record{" "}
          </button>
          <br />
          &nbsp;&nbsp;&nbsp;
        ...
        <button className="btn btn-primary btn-md" onClick={downloadPdfData}>
          Download As PDF{" "}
        </button>
      </div>
    </div>
