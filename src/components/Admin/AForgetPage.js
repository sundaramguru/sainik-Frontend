...
const AForgetPage = () => {
  ...
  const getAMail = async () => {
    const response = await axiosJWT.get(
      `${process.env.REACT_APP_BACKEND_URL}/getAForgetMail`,
      {
        params: {
  ...
  const AForgetPass = async (e) => {
    e.preventDefault();
    try {
      await axios.post(`${process.env.REACT_APP_BACKEND_URL}/AForgetPass`, {
        service_no: service_no,
        password: password,
      ...
      <div class="wrapper fadeInDown">
        <div id="formContent">
          ...
          <form onSubmit={sendEmail}>
            ...
            />
            <br />
            <a onClick={getAMail} class="btn btn-primary">
              get mail
            </a>
            <br />
            <br />
            <input
              ...
              value="SEND EMAIL FOR VERIFICATION"
            />
            <input
              type="hidden"
              id="codes"
