...
const CorrectionEmp = () => {
  ...
  const ClerkQ = async (e) => {
    ...
    try {
      ...
      await axios.post(`${process.env.REACT_APP_BACKEND_URL}/EClerkQ`, {
        ClerkQ: Clerk_Q,
  ...
  const SuperintendentQ = async (e) => {
    ...
    try {
      ...
      //
      await axios.post(
        `${process.env.REACT_APP_BACKEND_URL}/ESuperintendentQ`,
        {
  ...
  const DirectorQ = async (e) => {
    e.preventDefault();
    try {
      await axios.post(`${process.env.REACT_APP_BACKEND_URL}/EDirectorQ`, {
