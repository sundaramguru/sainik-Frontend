...
const Clerk = () => {
  ...
  localStorage.setItem("A_Designation", "Clerk");
  ...
  //     e.preventDefault();
  //     try {
  //       const response = await axiosJWT.get(`${process.env.REACT_APP_BACKEND_URL}/ESMDash`,{
  //         params:{
  //           ESM_No: localStorage.getItem('ESM_No')
  //         }
  //       });
  //
  //         console.log(ESM_No);
  //
  //         localStorage.setItem('A_ESM_No`,ESM_No);
  //         navigate("/adminform1");
  //     } catch (error) {
  //         if (error.response) {
  //             setMsg(error.response.data.msg);
                    ...
                    <tbody>
                      <tr key={user.id}>
                        ...
                        <td
                          ...
                          onChange={(e) =>
                            setSuperintendent(user.Superindendent)
                          }
                        >
                          {user.Superintendent}
                        </td>
