...
const FileUpload = () => {
  ...
  const getUsers = async () => {
    ...
    const response = await axiosJWT.get(
      `${process.env.REACT_APP_BACKEND_URL}/getimg`,
      {
        params: {
          A_Service_No: sn,
        },
    ...
    //     const url = `${process.env.REACT_APP_BACKEND_URL}/fetchImage/${imageName}`
  ...
  return (
    <div className="App">
      ...
      <div className="upperForm1Content">
        ...
        <img
          className="playerProfilePic_home_tile"
          url="../../server/public/images/file-1652717600728.png"
          style={{ width: "200px" }}
        ></img>
